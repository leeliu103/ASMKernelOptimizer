...
The system must produce an edited `<workspace>/variant/variant.s` that preserves the captured kernel's correctness and improves runtime versus the captured baseline.
